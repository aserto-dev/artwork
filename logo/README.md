...
<table>
    ...
    <tr>
        <th></th>
        <td><a download='aserto-horizontal-color.png' href="https://raw.githubusercontent.com/aserto-dev/artwork/main/logo/horizontal/color/aserto-horizontal-color.png?token=ASCYCOJ4565BYIXYOWJV4PK73E2WO">aserto-horizontal-color.png</a></td>
        <td>Download</td>
        <td>Download</td>
        <td>Download</td>
        <td>Download</td>
