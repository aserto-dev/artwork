...
<table>
    ...
    <tr>
        <th></th>
        <td><a download='aserto-horizontal-color.png' href="https://github.com/aserto-dev/artwork/raw/main/logo/horizontal/color/aserto-horizontal-color.png">aserto-horizontal-color.png</a></td>
        <td>Download</td>
        <td>Download</td>
        <td>Download</td>
        <td>Download</td>
